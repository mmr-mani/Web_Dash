...
st.markdown(f"### Like Score:  <span style='color:#f70202'><b>{round(filtered_raw_data['Score'].mean(),4)}</b></span>",unsafe_allow_html=True)
st.markdown(f"### Sentiment Score:  <span style='color:#f70202'><b>{round(filtered_raw_data['Sentiment_Score'].mean(),4)}</b></span>",unsafe_allow_html=True)
...
# st.dataframe(sentimentType_posthour_data)
